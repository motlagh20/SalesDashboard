...
export const PRESET_AGENTS: Agent[] = [
  {
    id: 'ag-5',
    fullName: 'آقای کاشانی',
    alias: 'نمایندگی جنوب (کاشانی)',
    agentCode: 'AG-3001',
    phoneNumber: '09170000001',
    address: 'بوشهر، خیابان مطهری، روبروی گمرک مرکزی، انبار نمایندگی جنوب',
    area: 'کل استان بوشهر؛ کل استان هرمزگان',
    territories: [
      { province: 'بوشهر', allCities: true },
      { province: 'هرمزگان', allCities: true }
    ],
    isExportAgent: true,
    isEnabled: true,
  },
  {
    id: 'ag-6',
    fullName: 'آقای شهبازی',
    alias: 'نمایندگی تهران و لواسان (شهبازی)',
    agentCode: 'AG-3002',
    phoneNumber: '09120000002',
    address: 'تهران، لواسان، بلوار امام خمینی، جنب میدان گلندوک، پلاک ۴۵',
    area: 'استان تهران (شهرهای: تهران، لواسان)',
    territories: [
      { province: 'تهران', allCities: false, cities: ['تهران', 'لواسان'] }
    ],
    isEnabled: true,
  },
  {
    ...
    area: 'استان تهران (شهرهای: تهران، شهریار، پردیس، دماوند)',
    territories: [
      { province: 'تهران', allCities: false, cities: ['تهران', 'شهریار', 'پردیس', 'دماوند'] }
    ],
    isEnabled: true,
  },
  {
    ...
    area: 'کل استان اصفهان؛ کل استان یزد',
    territories: [
      { province: 'اصفهان', allCities: true },
      { province: 'یزد', allCities: true }
    ],
    isEnabled: true,
  },
  {
    ...
    area: 'کل استان گیلان؛ کل استان مازندران',
    territories: [
      { province: 'گیلان', allCities: true },
      { province: 'مازندران', allCities: true }
    ],
    isEnabled: true,
  },
  {
